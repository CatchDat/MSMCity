...
Aggregate census data at MSOA level. 
...
Each API requres a key for without with downloads will be restricted or even unavailable. Obtaining a key will require registering with the sites.
...
1. Translate local authority string e.g "Newcastle upon Tyne" to MOSA code(s) (nomisweb internal, not "standard"), for use in later queries
...
```{r, echo=FALSE, out.width="50%", fig.show="hold", fig.cap="A sample of commute routes for a single MSOA. Private road transport."}
